...
public class TeamAdapter extends FirebaseRecyclerAdapter <TeamModel,TeamAdapter.teamViewHolder>{
    /**
    ...
    @Override
    protected void onBindViewHolder(@NonNull teamViewHolder holder, int position, @NonNull TeamModel model) {
