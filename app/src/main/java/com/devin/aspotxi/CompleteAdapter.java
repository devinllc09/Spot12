...
public class CompleteAdapter extends FirebaseRecyclerAdapter<CompleteModel, CompleteAdapter.liveholder> {
    Model model;
    /**
     ...
     * @param options
     */
    public CompleteAdapter(@NonNull FirebaseRecyclerOptions<CompleteModel> options) {
        super(options);
    }


    @Override
    protected void onBindViewHolder(@NonNull liveholder holder, int position, @NonNull CompleteModel model) {
